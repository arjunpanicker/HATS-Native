...
// #define LOGI(...) ((void)__android_log_print(ANDROID_LOG_INFO, "Fasttext", __VA_ARGS__))
// #define LOGW(...) ((void)__android_log_print(ANDROID_LOG_WARN, "Fasttext", __VA_ARGS__))

extern "C" {
	/* This trivial function returns the platform ABI for which this dynamic native library is compiled.*/
    namespace fasttext {
//         const char* FastText::getPlatformABI()
//         {
// #if defined(__arm__)
